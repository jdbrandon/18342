...
#define OSTMR_OSMR_ADDR(x)    (0x40A00000 + (x)*4)    /* OS Timer Match Register */

#define OSTMR_OSCR_ADDR       0x40A00010   /* OS Timer Count Register */

#define OSTMR_OSSR_ADDR       0x40A00014   /* OS Timer Status Register */
...
#define OSTMR_OWER_ADDR       0x40A00018   /* OS Timer Watchdog Enable Register */
#define OSTMR_OWER_WME        0x00000001   /* Watchdog mode enable */

#define OSTMR_OIER_ADDR       0x40A0001C   /* OS Timer Interrupt Enable Register */
